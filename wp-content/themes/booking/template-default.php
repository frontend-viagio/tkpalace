            ...
            ?>
							<div class="col-md-6">
								<a class="item" href="<?php echo $image; ?>" title="<?php bloginfo('name'); ?> : <?php the_title(); ?>">
									...
									<img src="<?php echo $item["sizes"]["image-single"];?>" width="<?php echo $item["sizes"]["image-single-width"];?>" height="<?php echo $item["sizes"]["image-single-height"];?>" class="img-responsive" alt="<?php bloginfo('name'); ?> : <?php the_title(); ?>">
								</a>
							</div>
