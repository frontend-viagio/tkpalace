...
if ( defined( 'WP_CLI' ) ) {
	class Ai1wmge_Gdrive_WP_CLI_Command extends WP_CLI_Command {
		 ...
		 * Backup complete.
		 * Backup file wordpress-20181121-094003-305.wpress located in https://drive.google.com/drive/u/0/folders/1YRhxGBcGVW_-GcreIvb9DyFOmrWIaWXt
		 * @subcommand backup
		 */
		public function backup( $args = array(), $assoc_args = array() ) {
			...
			$site_url = 'https://drive.google.com/drive/u/0/folders/';
			WP_CLI::log( sprintf( __( 'Backup file: %s located in: %s%s', AI1WMGE_PLUGIN_NAME ), ai1wm_archive_name( $params ), $site_url, $params['folder_id'] ) );
		}
